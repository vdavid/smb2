...
src/
  ...
  client/                 # High-level client API
    ...
    read_ahead.rs         # ReadAhead + the adaptive read-ahead controller behind FileDownload
