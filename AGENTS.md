...
src/
  ...
  client/                 # High-level client API
    ...
    read_ahead.rs         # ReadAhead + the adaptive pacing controller (`Window`) behind downloads AND uploads
