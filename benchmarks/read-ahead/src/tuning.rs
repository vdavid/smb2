...
pub(crate) const NAMES: &str = "shipping, ref, fixed250, fixed100, wmax16, wmax16-del, wmax8, wmax16-f20, meandev4, wmax16-n25, wmax16-n50, meandev4-n25";
...
pub(crate) fn parse(name: &str) -> Option<Tuning> {
    ...
    // counts as on time. (1 ms, 0) is the tolerance 4aa8361 shipped.
    let learned = |estimator, floor, (noise_floor, noise_share): (u64, f64)| {
    ...
    let (strict, n25, n50) = ((1, 0.0), (5, 0.25), (5, 0.5));
